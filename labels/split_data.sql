...
read_json (
    ...
    COLUMNS = {"classification": "string", "provider": "string", "method": "string", "locale": "string", "text": "string"});
...
COPY (select distinct label, classification from type_domain order by label)
